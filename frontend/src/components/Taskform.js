    ...
    >
      {({
        ...
        <Box p="2rem 0" m="2rem auto" width={isNotMobile ? "50%" : "90%"}>
          <Typography fontSize="35px"fontStyle= 'italic' color="#5B1E7C" textAlign="center" mb="2rem">
            YOUR TASK
          </Typography>
          <form onSubmit={handleSubmit}>
            <Box display="flex" flexDirection="column" gap="30px">
              ...
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DatePicker
                  label="Date"
                  value={mode ==="edit" ? dayjs(values.date || null) : dayjs(values.date)}
              ...
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <TimePicker
                  label="Time"
                  value={mode ==="edit" ? dayjs(`${values.date.split("T")[0]}T${values.time}` || null) : dayjs(values.time)}
                  onChange={(newValue) => {
